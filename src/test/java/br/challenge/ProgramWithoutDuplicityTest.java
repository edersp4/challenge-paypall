...
class ProgramWithoutDuplicityTest {

    @ParameterizedTest
    @MethodSource("inputs")
    void testInputAndOutput(int [] inputs , int targetSize) {
        final List<int[]> result = ProgramWithoutDuplicates.fourNumberSum(inputs, targetSize);
